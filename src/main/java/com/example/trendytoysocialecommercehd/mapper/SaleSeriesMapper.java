...
public interface SaleSeriesMapper extends BaseMapper<SaleSeries> {
    @Select("SELECT ss.sale_series_id, ss.shop_id, ss.series_id, ss.sale_title, ss.sale_description, " +
            "ss.sale_cover_image, ss.sale_status, ss.variant_count, ss.created_at, ss.updated_at, " +
            ...
            "ss.sale_cover_image, ss.sale_status, ss.variant_count, ss.created_at, ss.updated_at, s.shop_name")
